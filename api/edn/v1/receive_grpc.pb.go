...
type ReceiverClient interface {
	Recrive(ctx context.Context, in *ReceiveRequest, opts ...grpc.CallOption) (*ReceiveReply, error)
}
...
func (c *receiverClient) Recrive(ctx context.Context, in *ReceiveRequest, opts ...grpc.CallOption) (*ReceiveReply, error) {
	out := new(ReceiveReply)
	err := c.cc.Invoke(ctx, "/edn.v1.Receiver/Recrive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReceiverServer) Recrive(context.Context, *ReceiveRequest) (*ReceiveReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Recrive not implemented")
}
...
func _Receiver_Recrive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReceiveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReceiverServer).Recrive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/edn.v1.Receiver/Recrive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReceiverServer).Recrive(ctx, req.(*ReceiveRequest))
	}
...
var Receiver_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "edn.v1.Receiver",
	HandlerType: (*ReceiverServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Recrive",
			Handler:    _Receiver_Recrive_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "edn/v1/receive.proto",
}
